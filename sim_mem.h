...
#ifndef EX5_MEMORY_SIM_MEM_H
#define EX5_MEMORY_SIM_MEM_H
...
class sim_mem {
    ...
    int *availableLoc; //array that hold where is the free space in the main memory
    int *who_to_move_next;
    int text_size;
    int data_size;
    int bss_size;
    int heap_stack_size;
